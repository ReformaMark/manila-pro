    ...
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="md:w-1/4">
        <div className="relative h-48 w-48 mx-auto md:mx-0 rounded-lg overflow-hidden border border-gray-200">
          <Image src={agent.imageUrl || "/placeholder.svg"} alt={agent.lname} fill className="object-cover" />
        ...
        <div className="mt-4 text-center md:text-left">
          ...
          <div className="flex items-center justify-center md:justify-start mt-2 text-gray-500">
            ...
            <span>{agent.street} {agent.barangay}, {agent.city}</span>
          </div>
      ...
      <div className="md:w-2/4">
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg text-center">
            ...
            <p className="text-xl font-bold text-gray-900">{agent.transactions}+</p>
          </div>
          {/* <div className="bg-gray-50 p-3 rounded-lg text-center">
        ...
        <div className="mt-4">
          ...
          <p className="mt-2 text-gray-700">{agent.agentInfo?.bio}</p>
        </div>
      ...
      <div className="md:w-1/4">
        <Card className="border border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-gray-900">Contact {agent.fname}</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4 py-4">
                    <p className="text-sm text-gray-500">
                      Send a direct message to {agent.fname}. They typically respond within 24 hours.
                    </p>
                    <Textarea
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-700 text-sm">
                {agent.agentInfo?.officeAddress || "Office address not available"}
              </p>
