        ...
        <TabsContent value='Assigned'>
          <ScrollArea className='h-[700px] p-2 '>
            <div className="space-y-4">
              {assignedProperties && assignedProperties.map((property) => (
                <button type='button' onClick={() => handleSelectProperty(property)} key={property._id} 
                className={cn(
                  selectedProperty?._id  === property._id ? 'border-4 shadow-lg border-orange-400 rounded-lg':'',
