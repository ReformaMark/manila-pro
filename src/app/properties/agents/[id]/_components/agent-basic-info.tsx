    ...
    <div className="md:w-1/4">
        <div className="flex items-center justify-center relative h-48 w-48 mx-auto md:mx-0 rounded-lg overflow-hidden border border-gray-200">
            {agent.imageUrl ? (
                ...
                <Image src={agent.imageUrl} alt={agent.lname} fill className="object-cover" />
            ): (
                <p className=' text-center text-muted-foreground'>No uploaded image.</p>
            )}
        ...
        <div className="mt-4 text-center md:text-left">
            ...
            <span className="ml-1 font-bold text-gray-900">{agentRatingsAndReviews?.rating}</span>
            <span className="ml-1 text-gray-500">({agentRatingsAndReviews?.reviews.length} reviews)</span>
            </div>
